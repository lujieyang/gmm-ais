...
def GetTestParameters0(ncBelief=4, ncAlpha=9, actionScale=2):
    """
...
def GetTestParameters1(ncBelief=4, ncAlpha=9, actionScale=2):
    """
    :param ncBelief: Number of components in the belief mixtures.
    :param ncAlpha: Number of components in the alpha mixtures.
    :param actionScale: Scale factor to apply to the right/left displacements.
...
def GetTestParameters2(ncBelief=4, ncAlpha=9, actionScale=2):
    """
    :param ncBelief: Number of components in the belief mixtures.
    :param ncAlpha: Number of components in the alpha mixtures.
    :param actionScale: Scale factor to apply to the right/left displacements.
    ...
    rm.append(GMixture(np.array([-2, -2, -2]), [Gaussian(-21, 1), Gaussian(-19, 1), Gaussian(-17, 1)]))
    rm.append(GMixture(np.array([-2, -2, -2]), [Gaussian(21, 1), Gaussian(19, 1), Gaussian(17, 1)]))
    rm.append(GMixture(np.array([-4, 6, -4]), [Gaussian(-25, 250), Gaussian(3, 3), Gaussian(25, 250)]))
    RM = CS_DA_RewardModel(S, A, rm)
...
def GetTestParameters3(ncBelief=4, ncAlpha=9, actionScale=2):
    """
    :param ncBelief: Number of components in the belief mixtures.
    :param ncAlpha: Number of components in the alpha mixtures.
    :param actionScale: Scale factor to apply to the right/left displacements.
    ...
    rm.append(GMixture(np.array([-2, -2, -2]), [Gaussian(-21, 1), Gaussian(-19, 1), Gaussian(-17, 1)]))
    rm.append(GMixture(np.array([-2, -2, -2]), [Gaussian(21, 1), Gaussian(19, 1), Gaussian(17, 1)]))
    rm.append(GMixture(np.array([-8, 6, -8]), [Gaussian(-25, 250), Gaussian(3, 2), Gaussian(25, 250)]))
    RM = CS_DA_RewardModel(S, A, rm)
...
if __name__ == "__main__":
    test = "Test1"
    POMDP, P = GetTestParameters3(ncBelief=10)
